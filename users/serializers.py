...
class UserRegistrationSerializer(RegisterSerializer):
    ...
    def get_cleaned_data_extra(self):
        return {
            "phone_number":self.validated_data.get("phone_numer",""),
    ...
    def custom_signup(self, request, user):
        return self.create_extra(user,self.get_cleaned_data_extra())
...
class UserLoginSerializer(serializers.Serializer):
    ...
    def validate(self,validated_data):
        ...
        if email:
            email_verified=user.emailaddress_set.filter(email=user.email,verified=True).exists()
